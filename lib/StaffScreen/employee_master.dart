...
class _EmployeeMasterState extends State<EmployeeMaster> {
  ...
  void initState() {
    ...
    fields = [
      ...
      {'label': 'Left Date', 'controller': TextEditingController()},
      {
        ...
        'value': 'Select',
        'items': ['Select', 'Confirmation', 'Probation', 'Trial', 'Training'],
      },
  ...
  Future<void> _pickDate(
    ...
    final initialDate =
        DateTime.tryParse(field['controller']?.text ?? '') ?? now;
        ...
        children: [
          Text(
            ...
            style: TextStyle(
              ...
              fontSize: (MediaQuery.of(context).size.width * 0.0375).clamp(
                13.0,
                17.0,
              ),
