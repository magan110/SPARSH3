...
class _RetailerRegistrationPageState extends State<RetailerRegistrationPage> {
  ...
  // ======================
  final TextEditingController _stockistCodeController = TextEditingController();
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          colors: [Color(0xFF7AB8FF), Color(0xFFC1DAFF)],
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        debugPrint(
                          'Retailer Category: $_selectedRetailerCategory',
                        );
                        ...
                        debugPrint(
                          'Office Tel: ${_officeTelephoneController.text}',
                        );
                        ...
                        debugPrint(
                          'Stockist Code: ${_stockistCodeController.text}',
                        );
                        debugPrint(
                          'Tally Code: ${_tallyRetailerCodeController.text}',
                        );
                        debugPrint(
                          'Concern Emp: ${_concernEmployeeController.text}',
                        );
                        debugPrint('Scheme: ${_schemeRequiredController.text}');
                        debugPrint(
                          'Aadhar No: ${_aadharNumberController.text}',
                        );
                        debugPrint('Aadhar Pin: ${_aadharPinController.text}');
                        debugPrint(
                          'Proprietor Name: ${_proprietorNameController.text}',
                        );

                        debugPrint(
                          'Account Holder Name: ${_accountHolderNameController.text}',
                        );
                        ...
                        debugPrint(
                          'Bank Branch No: ${_bankBranchNoController.text}',
                        );
                        debugPrint(
                          'Bank Branch Name: ${_bankBranchNameController.text}',
                        );
                        debugPrint(
                          'Bank Branch Desc: ${_bankBranchDescController.text}',
                        );

                        debugPrint(
                          'Business Start Year: ${_businessStartedYearController.text}',
                        );
                        debugPrint(
                          'Started with Birla Year: ${_startedWithBirlaYearController.text}',
                        );
                        debugPrint('Business Types: $_selectedBusinessTypes');
                        debugPrint(
                          'Paint/Non-Paint Type: $_selectedPaintNonPaintType',
                        );
                        debugPrint('KYC Verified: $_selectedKycVerified');
                        debugPrint(
                          'Bank KYC Verified: $_selectedBankKycVerified',
                        );
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 6),
                DropdownButtonFormField<String>(
                  value: _selectedRetailerCategory ?? _retailerCategories.first,
                  decoration: _inputDecoration(),
                  items:
                      _retailerCategories.map((cat) {
                ...
                TextField(
                  ...
                  keyboardType: TextInputType.phone,
                  decoration: _inputDecoration(hintText: 'Office Telephone 1'),
                ),
                const SizedBox(height: 16),
                ...
                DropdownButtonFormField<String>(
                  ...
                  items:
                      _pinCodes.map((pin) {
                        return DropdownMenuItem(value: pin, child: Text(pin));
                      }).toList(),
                  onChanged: (value) {
                    setState(() {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              value:
                  _schemeRequiredController.text.isEmpty
                      ? _schemes.first
            ...
            const Text('Aadhar Card Pin Code', style: TextStyle(fontSize: 14)),
            const SizedBox(height: 6),
            Row(
              children: [
                ElevatedButton(
            ...
            TextField(
              ...
              decoration: _inputDecoration(
                hintText: 'Proprietor / Partner Name',
              ),
            ),
            const SizedBox(height: 16),
          ],
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Started business with BirlaWhite Year',
              style: TextStyle(fontSize: 14),
            ),
            const SizedBox(height: 6),
            TextField(
                        ...
                        child: Column(
                          ...
                          children:
                              _businessTypes.map((type) {
                                final bool checked = _selectedBusinessTypes
                                    .contains(type);
