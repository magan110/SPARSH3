          ...
          title: LayoutBuilder(
            builder: (context, constraints) {
              ...
              return Text(
                isMobile
                    ? 'Employee Dashboard'
                    : 'Employee DashBoard – Confidential',
                style: TextStyle(
                  color: Colors.white,
          ...
          isMobile
              ? Wrap(
                ...
                children: [
                  ...
                  _buildMetricItem(
                    'Total Unique Visited Retailer',
                    '0',
                    isMobile,
                  ),
                  _buildMetricItem(
                    'Visited Unique Mapped Retailer',
                    '0',
                    isMobile,
                  ),
      ...
      child: Column(
        ...
        children: [
          ...
          Table(
            ...
            columnWidths:
                isMobile
                    ? const {0: FlexColumnWidth(2.5), 1: FlexColumnWidth(1)}
                    : const {0: FlexColumnWidth(3), 1: FlexColumnWidth(1)},
            children: [
              _buildTableRow(
                'No. of Retailers (mapped to employee)',
                unbilledCount.toString(),
                isMobile,
              ),
              _buildTableRow(
                'Billed in Curr Month',
                billedCount.toString(),
                isMobile,
              ),
              _buildTableRow(
                'Unbilled in Curr Month',
                unbilledCurrMonth.toString(),
                isMobile,
              ),
