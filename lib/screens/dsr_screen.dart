...
class _DsrScreenState extends State<DsrScreen>
          ...
          Center(
            child: InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  border: Border.all(
                    color: ThemeUtils.getAppTheme().primaryColor.withValues(
                      alpha: 0.5,
                    ),
  ...
  Widget _buildActivitySection() {
    ...
    final List<Map<String, Object>> activities = [
      ...
      {
        'title': 'Visit to Get / Check Sampling at Site',
        ...
        body: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                ThemeUtils.getAppTheme().primaryColor.withValues(alpha: 0.05),
                Colors.white,
              ],
            ),
          ),
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [
                          ...
                          ThemeUtils.getAppTheme().primaryColor.withValues(
                            alpha: 0.8,
                          ),
                        ],
                      ),
