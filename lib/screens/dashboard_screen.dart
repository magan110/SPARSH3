            ...
            Stack(
              children: [
                Container(
                  ...
                  child: CircleAvatar(
                    radius: (screenWidth * 0.08).clamp(24.0, 40.0),
                    backgroundColor: Colors.transparent,
                    child: Icon(
                      Icons.person_rounded,
                      size: (screenWidth * 0.1).clamp(30.0, 50.0),
                      color: Colors.white,
                    ),
                  ),
                ),
                Positioned(
                  ...
                  child: Container(
                    width: (screenWidth * 0.032).clamp(10.0, 16.0),
                    height: (screenWidth * 0.032).clamp(10.0, 16.0),
                    decoration: BoxDecoration(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "₹ 0",
                  style: GoogleFonts.poppins(
                    fontSize: (MediaQuery.of(context).size.width * 0.075).clamp(
                      24.0,
                      36.0,
                    ),
  ...
  static Widget _buildCreditInfoRow(String title, int value) {
    return Builder(
      builder: (context) {
        final screenWidth = MediaQuery.of(context).size.width;
        return Padding(
          padding: EdgeInsets.symmetric(vertical: screenWidth * 0.0175),
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Expanded(
            ...
            children:
                _products.map((prod) {
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      color: prod.color.withValues(alpha: 0.1),
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
                        color: prod.color.withValues(alpha: 0.3),
                      ),
                    ),
                    child: Text(
                      prod.name.replaceAll('\n', ' '),
              ...
              LineChartData(
                ...
                lineBarsData: [
                  LineChartBarData(
                    spots: List.generate(
                      _products.length,
                      (i) => FlSpot(i.toDouble(), _products[i].value),
                    ),
                    isCurved: true,
