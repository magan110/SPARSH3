...
class _SchemeDocumentPageState extends State<SchemeDocumentPage> {
  ...
  final List<String> _purchaserEmployees = [
    'Select',
    'Employee A',
    'Employee B',
  ];
  final List<String> _geographies = [
    'Select',
    'North',
    'South',
    'East',
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        debugPrint('Type of Circular: $_selectedCircularType');
                        debugPrint(
    ...
    return Column(
      ...
      children: [
              ...
              builder:
                  (_) => Padding(
                    ...
                    child: Column(
                      ...
                      children:
                          _userTypes.map((ut) {
                            final bool checked = _selectedUserTypes.contains(
                              ut,
                            );
                            return CheckboxListTile(
                              title: Text(ut),
        ...
        TextField(
          ...
          decoration: _inputDecoration(hintText: 'Enter description here...'),
        ),
        const SizedBox(height: 16),
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    value:
                        _selectedPurchaserEmployee ?? _purchaserEmployees.first,
                    decoration: _inputDecoration(),
                    items:
                        _purchaserEmployees.map((pe) {
                          return DropdownMenuItem(value: pe, child: Text(pe));
                        ...
                        builder:
                            (_) => Padding(
                              ...
                              child: Column(
                                ...
                                children:
                                    _types.map((type) {
                                      final bool checked = _selectedType
                                          .contains(type);
                                      return CheckboxListTile(
                                        title: Text(type),
                                        value: checked,
                        ...
                        builder:
                            (_) => Padding(
                              ...
                              child: Column(
                                ...
                                children:
                                    _userTypes.map((ut) {
                                      final bool checked = _selectedUserTypes
                                          .contains(ut);
                                      return CheckboxListTile(
                                        title: Text(ut),
                                        value: checked,
