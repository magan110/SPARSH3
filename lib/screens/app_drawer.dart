...
class _AppDrawerState extends State<AppDrawer> {
  ...
  Widget build(BuildContext context) {
    ...
    return Drawer(
      ...
      width: (screenWidth * 0.8).clamp(250.0, 320.0), // Responsive drawer width
              ...
              children: [
                ...
                Container(
                  ...
                  child: Image.asset(
                    ...
                    height: (screenHeight * 0.08).clamp(60.0, 100.0),
                    fit: BoxFit.contain,
                    errorBuilder: (context, error, stackTrace) {
                      print('Error loading drawer header image: $error');
                      return Icon(
                        Icons.business,
                        size: (screenWidth * 0.15).clamp(40.0, 80.0),
                        color: Colors.white,
      ...
      children: [
                      ...
                      style: TextStyle(
                        ...
                        fontWeight:
                            isSelected || isExpanded
                                ? FontWeight.bold
                                : FontWeight
                                    .normal, // Bold text for selected/expanded
                      ),
        ...
        if (isExpanded) ...[
          Padding(
            ...
            ), // Responsive indent for sub-items
            child: Column(
  ...
  // Helper method to build responsive sub-item padding
  Widget _buildResponsiveSubItem({
              ...
              children: [
                ...
                if (_isFinancialAccountsExpanded) ...[
                  Padding(
                    ...
                    ), // Responsive indent for sub-sub-items
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children:
            ...
            InkWell(
              ...
              child: Padding(
                padding: EdgeInsets.symmetric(
                  horizontal: screenWidth * 0.04,
                  vertical: screenWidth * 0.025,
                ), // Responsive padding for sub-items
                child: Row(
                  children: [
                    Icon(
                      Icons.circle,
                      size: (screenWidth * 0.02).clamp(6.0, 10.0),
                      color: Colors.blueGrey[300],
                    ), // Responsive small leading icon
